...
// Please note these are limited to 17 characters!
	...
	#define MSG_MAIN             "Hauptmen羹"
	#define MSG_AUTOSTART        "Autostart"
	#define MSG_DISABLE_STEPPERS "Stepper abschalt."
	#define MSG_AUTO_HOME        "Auto Nullpunkt"
	#define MSG_SET_ORIGIN       "Setze Nullpunkt"
	#define MSG_PREHEAT_PLA      "Vorw瓣rmen PLA"
	#define MSG_PREHEAT_PLA0     "Vorw瓣rmen PLA 1"
	#define MSG_PREHEAT_PLA1     "Vorw瓣rmen PLA 2"
	#define MSG_PREHEAT_PLA2     "Vorw瓣rmen PLA 3"
	#define MSG_PREHEAT_PLA012   "Vorw. PLA Alle"
	#define MSG_PREHEAT_PLA_BEDONLY "Vorw. PLA Bett"
	#define MSG_PREHEAT_PLA_SETTINGS "Vorw瓣rm. PLA Ein."
	#define MSG_PREHEAT_ABS      "Vorw瓣rmen ABS"
	#define MSG_PREHEAT_ABS0     "Vorw瓣rmen ABS 1"
	#define MSG_PREHEAT_ABS1     "Vorw瓣rmen ABS 2"
	#define MSG_PREHEAT_ABS2     "Vorw瓣rmen ABS 3"
	#define MSG_PREHEAT_ABS012   "Vorw. ABS Alle"
	#define MSG_PREHEAT_ABS_BEDONLY "Vorw. ABS Bett"
	#define MSG_PREHEAT_ABS_SETTINGS "Vorw瓣rm. ABS Ein."
	#define MSG_COOLDOWN         "Abk羹hlen"
	#define MSG_SWITCH_PS_ON     "Switch Power On"
	#define MSG_SWITCH_PS_OFF    "Switch Power Off"
	#define MSG_EXTRUDE          "Extrude"
	#define MSG_RETRACT          "Retract"
	...
	#define MSG_NOZZLE           "D羹se"
	#define MSG_NOZZLE1          "D羹se2"
	#define MSG_NOZZLE2          "D羹se3"
	#define MSG_BED              "Bett"
	#define MSG_FAN_SPEED        "L羹ftergeschw."
	...
	#define MSG_CARD_MENU        "SDKarten Men羹"
...
// Serial Console Messages
	...
	#define MSG_ERR_KILLED "癒癒Impresora Parada con kill()!!"
	#define MSG_ERR_STOPPED "癒Impresora parada por errores. Arregle el error y use M999 Para reiniciar!. (La temperatura se reestablece. Ajustela despues de continuar)"
...
// Please note these are limited to 17 characters!
	...
	#define WELCOME_MSG MACHINE_NAME			        "�郋�郋赲."
	#define MSG_SD_INSERTED						"�訄��訄 赲��訄赲郅迮郇訄"
	#define MSG_SD_REMOVED						"�訄��訄 邽郱赲郅迮�迮郇訄"
	#define MSG_MAIN							"�迮郇� \003"
	#define MSG_AUTOSTART						"�赲�郋��訄��"
	#define MSG_DISABLE_STEPPERS 				"��郕郅. 迡赲邽迣訄�迮郅邽"
	#define MSG_AUTO_HOME						"�訄�郕郋赲郕訄"
	#define MSG_SET_ORIGIN						"�訄郈郋邾郇邽�� 郇郋郅�"
	#define MSG_PREHEAT_PLA 					"��迮迡郇訄迣�迮赲 PLA"
	#define MSG_PREHEAT_PLA0					"��迮迡郇訄迣�迮赲 PLA0"
	#define MSG_PREHEAT_PLA1					"��迮迡郇訄迣�迮赲 PLA1"
	#define MSG_PREHEAT_PLA2					"��迮迡郇訄迣�迮赲 PLA2"
	#define MSG_PREHEAT_PLA012 					"��迮迡郇訄迣. PLA 赲�迮"
	#define MSG_PREHEAT_PLA_BEDONLY 			"��迮迡. PLA ��郋赲訄��"
	#define MSG_PREHEAT_PLA_SETTINGS  			"�訄���郋邿郕邽 PLA"
	#define MSG_PREHEAT_ABS						"��迮迡郇訄迣�迮赲 ABS"
	#define MSG_PREHEAT_ABS0					"��迮迡郇訄迣�迮赲 ABS0"
	#define MSG_PREHEAT_ABS1					"��迮迡郇訄迣�迮赲 ABS1"
	#define MSG_PREHEAT_ABS2					"��迮迡郇訄迣�迮赲 ABS2"
	#define MSG_PREHEAT_ABS012 					"��迮迡郇訄迣. ABS 赲�迮 "
	#define MSG_PREHEAT_ABS_BEDONLY 			"��迮迡. ABS ��郋赲訄��"
	#define MSG_PREHEAT_ABS_SETTINGS  			"�訄���郋邿郕邽 ABS"
	#define MSG_COOLDOWN						"��郅訄迠迡迮郇邽迮"
	#define MSG_SWITCH_PS_ON					"Switch Power On"
	#define MSG_SWITCH_PS_OFF					"Switch Power Off"
	#define MSG_EXTRUDE							"衪郕����郱邽�"
	#define MSG_RETRACT							"��郕訄�"
	#define MSG_MOVE_AXIS  						"�赲邽迠迮郇邽迮 郈郋 郋��邾"
	#define MSG_MOVE_X                          "Move X"
	#define MSG_MOVE_Y                          "Move Y"
	#define MSG_MOVE_Z                          "Move Z"
	#define MSG_MOVE_E                          "Extruder"
	...
	#define MSG_MOVE_1MM                        "Move 1mm"
	#define MSG_MOVE_10MM                       "Move 10mm"
	#define MSG_SPEED							"苤郕郋�郋���:"
	#define MSG_NOZZLE							"\002 苳邽郅�迮�訄:"
	#define MSG_NOZZLE1							"\002 苳邽郅�迮�訄2:"
	#define MSG_NOZZLE2							"\002 苳邽郅�迮�訄3:"
	#define MSG_BED								"\002 ��郋赲訄��:"
	#define MSG_FAN_SPEED						"��郅郅迮�:"
	#define MSG_FLOW							"�郋�郋郕:"
	#define MSG_FLOW0 " �郋�郋郕0:"
	#define MSG_FLOW1 " �郋�郋郕1:"
	#define MSG_FLOW2 " �郋�郋郕2:"
	#define MSG_CONTROL							"�訄���郋邿郕邽 \003"
	#define MSG_MIN								"\002 �邽郇邽邾�邾:"
	#define MSG_MAX								"\002 �訄郕�邽邾�邾:"
	#define MSG_FACTOR							"\002 苳訄郕�郋�:"
	#define MSG_AUTOTEMP						"Autotemp:"
	#define MSG_ON								"�郕郅. "
	#define MSG_OFF								"��郕郅. "
	#define MSG_PID_P							"PID-P: "
	...
	#define MSG_AMAX							"Amax "
	#define MSG_A_RETRACT						"A-retract:"
	#define MSG_XSTEPS							"X �訄迣/mm:"
	#define MSG_YSTEPS							"Y �訄迣/mm:"
	#define MSG_ZSTEPS							"Z �訄迣/mm:"
	#define MSG_ESTEPS							"E �訄迣/mm:"
	#define MSG_RECTRACT    					"��郕訄� 郈郋迡訄�邽    \x7E"
	#define MSG_TEMPERATURE  					"苠迮邾郈迮�訄���訄     \x7E"
	#define MSG_MOTION							"苤郕郋�郋��邽        \x7E"
	#define MSG_CONTRAST  						"LCD contrast"
	#define MSG_STORE_EPROM  					"苤郋��訄郇邽�� 赲 EPROM"
	#define MSG_LOAD_EPROM  					"�訄迣��郱. 邽郱 EPROM"
	#define MSG_RESTORE_FAILSAFE				"苤訇�郋� 郇訄���郋迮郕"
	#define MSG_REFRESH							"\004�訇郇郋赲邽��"
	#define MSG_WATCH							"�訇郱郋�           \003"
	#define MSG_PREPARE							"�迮邿��赲邽�        \x7E"
	#define MSG_TUNE							"�訄���郋邿郕邽       \x7E"
	#define MSG_PAUSE_PRINT  					"��郋迡郋郅迠邽�� 郈迮�訄��"
	#define MSG_RESUME_PRINT					"赲郋郱郋訇郇. 郈迮�訄��"
	#define MSG_STOP_PRINT 						"���訄郇郋赲邽�� 郈迮�訄��"
	#define MSG_CARD_MENU						"�迮郇� 郕訄���      \x7E"
	#define MSG_NO_CARD							"�迮� 郕訄���"
	#define MSG_DWELL							"苤郋郇..."
	#define MSG_USERWAIT  						"�迠邽迡訄郇邽邽迮"
	#define MSG_RESUMING 						"Resuming print"
	#define MSG_NO_MOVE							"�迮� 迡赲邽迠迮郇邽�."
	#define MSG_KILLED							"苺��苠�."
	#define MSG_STOPPED							"�苤苠��������."
	#define MSG_CONTROL_RETRACT					"��郕訄� mm:"
	#define MSG_CONTROL_RETRACT_SWAP				"�赲郋郈 ��郕訄� mm:"
	#define MSG_CONTROL_RETRACTF				"��郕訄�  V:"
	#define MSG_CONTROL_RETRACT_ZLIFT			"���迠郋郕 mm:"
	#define MSG_CONTROL_RETRACT_RECOVER			"�郋郱赲�訄� +mm:"
	#define MSG_CONTROL_RETRACT_RECOVER_SWAP		"�赲郋郈 �郋郱赲�訄� +mm:"
	#define MSG_CONTROL_RETRACT_RECOVERF		"�郋郱赲�訄�  V:"
	#define MSG_AUTORETRACT						"�赲�郋��郕訄�:"
	#define MSG_FILAMENTCHANGE 					"Change filament"
	#define MSG_INIT_SDCARD 					"Init. SD-Card"
	#define MSG_CNG_SDCARD 						"Change SD-Card"
	#define MSG_ZPROBE_OUT 						"Z probe out. bed"
...
// Serial Console Messages
	...
	#define MSG_Enqueing						"�訄郈郅訄郇邽�郋赲訄郇郋 \""
	#define MSG_POWERUP							"�郕郅��迮郇邽迮 郈邽�訄郇邽�"
	#define MSG_EXTERNAL_RESET					" �郇迮�郇邽邿 �訇�郋�"
	#define MSG_BROWNOUT_RESET					" Brown out �訇�郋�"
	#define MSG_WATCHDOG_RESET					" Watchdog �訇�郋�"
	#define MSG_SOFTWARE_RESET					" 郈�郋迣�訄邾邾郇�邿 �訇�郋�"
	#define MSG_AUTHOR							" | �赲�郋�: "
	#define MSG_CONFIGURATION_VER				" �郋�郅迮迡郇迮迮 郋訇郇郋赲郅迮郇邽迮: "
	#define MSG_FREE_MEMORY						" �訄邾��邽 �赲郋訇郋迡郇郋: "
	#define MSG_PLANNER_BUFFER_BYTES			"  ����迮� 郋�迮�迮迡邽 郕郋邾訄郇迡 Bytes: "
	#define MSG_OK								"ok"
	#define MSG_FILE_SAVED						"苳訄邿郅 郱訄郈邽�訄郇."
	#define MSG_ERR_LINE_NO						"�郋邾迮郇 ���郋郕邽 ��郋 郇迮 郈郋�郅迮迡郇�� ���郋郕訄+1, 郈郋�郅迮迡郇�� ���郋郕訄:"
	#define MSG_ERR_CHECKSUM_MISMATCH			"郕郋郇��郋郅�郇訄� ��邾邾訄 郇迮 �郋赲郈訄迡訄迮�, 郈郋�郅迮迡郇�� ���郋郕訄:"
	#define MSG_ERR_NO_CHECKSUM					"郇迮� 郕郋郇��郋郅�郇郋邿 ��邾邾� 迡郅� ���郋郕邽, 郈郋�郅迮迡郇�� ���郋郕訄:"
	#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM	"郇迮� ���郋郕邽 迡郅� 郕郋郇��郋郅�郇郋邿 ��邾邾�, 郈郋�郅迮迡郇�� ���郋郕訄:"
	#define MSG_FILE_PRINTED					"�迮�訄�� �訄邿郅訄 郱訄赲迮��迮郇訄"
	#define MSG_BEGIN_FILE_LIST					"苤郈邽�郋郕 �訄邿郅郋赲"
	#define MSG_END_FILE_LIST					"�郋郇迮� �郈邽�郕訄 �訄邿郅郋赲"
	#define MSG_M104_INVALID_EXTRUDER			"M104 郋�邽訇郕訄 �郕����迡迮�訄 "
	#define MSG_M105_INVALID_EXTRUDER			"M105 郋�邽訇郕訄 �郕����迡迮�訄 "
	#define MSG_M200_INVALID_EXTRUDER			"M200 郋�邽訇郕訄 �郕����迡迮�訄 "
	#define MSG_M218_INVALID_EXTRUDER			"M218 郋�邽訇郕訄 �郕����迡迮�訄 "
	#define MSG_M221_INVALID_EXTRUDER			"M221 郋�邽訇郕訄 �郕����迡迮�訄 "
	#define MSG_ERR_NO_THERMISTORS				"�迮� �迮�邾邽���訄 - 郇迮� �迮邾郈迮�訄����"
	#define MSG_M109_INVALID_EXTRUDER			"M109 郋�邽訇郕訄 �郕����迡迮�訄 "
	#define MSG_HEATING							"�訄迣�迮赲...  "
	#define MSG_HEATING_COMPLETE				"�訄�迣迮�郋.    "
	#define MSG_BED_HEATING						"�訄迣�迮赲 ��郋郅訄...     "
	#define MSG_BED_DONE						"苤�郋郅 郇訄迣�迮�.        "
	#define MSG_M115_REPORT						"FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
	#define MSG_COUNT_X							" Count X:"
	#define MSG_ERR_KILLED						"��邽郇�迮� 郋��訄郇郋赲郅迮郇. 赲�郱郋赲 kill() !!"
	#define MSG_ERR_STOPPED						"��邽訇郕訄 郈�邽郇�迮�訄, 郋��訄郇郋赲. 苺���訄郇邽�迮 郇迮邽�郈�訄赲郇郋��� 邽 邽�郈郋郅�郱�邿�迮 M999 迡郅� 郈迮�迮郱訄迣��郱郕邽!. (苠迮邾郈迮�訄���訄 郇迮迡郋���郈郇訄. ��郋赲迮���迮 迡訄��邽郕邽)"
	#define MSG_RESEND							"�迮�迮郋�郈�訄赲郕訄:"
	#define MSG_UNKNOWN_COMMAND					"�迮邽郱赲迮��郇訄� 郕郋邾訄郇迡訄:\""
	#define MSG_ACTIVE_EXTRUDER					"�郕�邽赲郇�邿 �郕����迡迮�: "
	#define MSG_INVALID_EXTRUDER				"��邽訇郕訄 �郕����迡迮�訄"
	#define MSG_X_MIN							"x_min:"
	#define MSG_X_MAX							"x_max:"
	#define MSG_Y_MIN							"y_min:"
	#define MSG_Y_MAX							"y_max:"
	#define MSG_Z_MIN							"z_min:"
	#define MSG_Z_MAX							"z_max:"
	#define MSG_M119_REPORT						"苤�訄��� 郕郋郇�迮赲邽郕郋赲"
	#define MSG_ENDSTOP_HIT						"苤�訄訇訄��赲訄郇邽迮 郕郋郇�迮赲邽郕訄"
	#define MSG_ENDSTOP_OPEN					"�郋郇�迮赲邽郕 郋�赲郋訇郋迠迡迮郇"
	#define MSG_HOTEND_OFFSET					"Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR				"�迮 郋�郕���� 郈訄郈郕�"
	#define MSG_SD_INIT_FAIL					"��邽訇郕訄 邽郇邽�邽訄郅邽郱訄�邽邽 SD"
	#define MSG_SD_VOL_INIT_FAIL				"��邽訇郕訄 邽郇邽�邽訄郅邽郱訄�邽邽 �訄郱迡迮郅訄"
	#define MSG_SD_OPENROOT_FAIL				"�迮 郈�郋�迮��� �郋迡迮�迠邽邾郋迮 郕郋�郇�"
	#define MSG_SD_CARD_OK						"SD 郕訄��訄 赲 郈郋��迡郕迮"
	#define MSG_SD_WORKDIR_FAIL					"郇迮 郋�郕���� �訄訇郋��� 郈訄郈郕�"
	#define MSG_SD_OPEN_FILE_FAIL				"��邽訇郕訄 ��迮郇邽�, �訄邿郅: "
	#define MSG_SD_FILE_OPENED					"苳訄邿郅 郋�郕���:"
	#define MSG_SD_SIZE							" �訄郱邾迮�:"
	#define MSG_SD_FILE_SELECTED				"苳訄邿郅 赲�訇�訄郇"
	#define MSG_SD_WRITE_TO_FILE				"�訄郈邽�� 赲 �訄邿郅: "
	#define MSG_SD_PRINTING_BYTE				"SD 郈迮�訄�� byte "
	#define MSG_SD_NOT_PRINTING					"郇迮� SD 郈迮�訄�邽"
	#define MSG_SD_ERR_WRITE_TO_FILE			"郋�邽訇郕訄 郱訄郈邽�邽 赲 �訄邿郅"
	#define MSG_SD_CANT_ENTER_SUBDIR			"�迮 郱訄邿�邽 赲 郈訄郈郕�:"
	#define MSG_STEPPER_TOO_HIGH				"虴訄��郋�訄 �訄迣郋赲 郋�迮郇� 赲��郋郕訄 : "
	#define MSG_ENDSTOPS_HIT					"郕郋郇�迮赲邽郕 ��訄訇郋�訄郅: "
	#define MSG_ERR_COLD_EXTRUDE_STOP			" 郱訄�邽�訄 �郋郅郋迡郇郋邿 �郕����郱邽邽"
	#define MSG_ERR_LONG_EXTRUDE_STOP			" 郱訄�邽�訄 郈�迮赲��迮郇邽� 迡郅邽郇郇� �郕����郱邽邽"
	#define MSG_BABYSTEPPING_X "Babystepping X"
	#define MSG_BABYSTEPPING_Y "Babystepping Y"
	#define MSG_BABYSTEPPING_Z "Babystepping Z"
	#define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
...
// Serial Console Messages
	...
	#define MSG_BEGIN_FILE_LIST "Come癟o da lista de arquivos"
	#define MSG_END_FILE_LIST "Fim da lista de arquivos"
	#define MSG_M104_INVALID_EXTRUDER "M104 Extrusor inv獺lido "
	#define MSG_M105_INVALID_EXTRUDER "M105 Extrusor inv獺lido "
	#define MSG_M200_INVALID_EXTRUDER "M200 Extrusor inv獺lido "
	#define MSG_M218_INVALID_EXTRUDER "M218 Extrusor inv獺lido "
	#define MSG_M221_INVALID_EXTRUDER "M221 Extrusor inv獺lido "
	#define MSG_ERR_NO_THERMISTORS "Nao ha termistor - no temp"
	#define MSG_M109_INVALID_EXTRUDER "M109 Extrusor inv獺lido "
	...
	#define MSG_ERR_STOPPED "Impressora parada por erros. Coserte o erro e use M999 para recome癟ar!. (Temperatura reiniciada. Ajuste antes de recome癟ar)"
	#define MSG_RESEND "Reenviar:"
...
// Serial Console Messages
	...
	#define MSG_ERR_NO_CHECKSUM "No se podi籀 trobar o Checksum con o numero de linea, Ultima Linea:"
	...
	#define MSG_HOTEND_OFFSET "Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR "No se podi籀 ubrir a subcarpeta."
...
// Please note these are limited to 17 characters!
	...
	#define MSG_PREHEAT_PLA_SETTINGS "Configuraci籀 PLA"
	...
	#define MSG_PREHEAT_ABS_SETTINGS "Configuraci籀 ABS"
